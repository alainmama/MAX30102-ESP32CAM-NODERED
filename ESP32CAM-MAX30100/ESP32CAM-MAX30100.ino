...
const char* password = "05345229";  // Aquí debes poner la contraseña de tu red

//Datos del broker MQTT
const char* mqtt_server = "192.168.0.108"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
